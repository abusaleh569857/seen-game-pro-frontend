...
const PACKAGES = [
  {
    ...
    qeem: '5',
    price: '1.5 KWD',
    desc: 'Perfect for trying Jokers',
    popular: false,
    icons: '🪙',
    bgColor: '#1D1A33',
    borderColor: '#302D4F'
  ...
  },
  {
    ...
    qeem: '50',
    price: '9 KWD',
    desc: 'For serious competitors',
    popular: false,
    icons: '🪙 💼', // Wait, the image shows a bag of coins
    bgColor: '#3F1235',
    borderColor: '#691D58'
  }
];
          ...
          {PACKAGES.map((pkg, i) => (
            ...
            >
              ...
              <div className="flex items-baseline gap-1.5 mb-1">
                <span className="text-[42px] lg:text-[48px] font-black text-white leading-none">
                  {pkg.qeem}
                </span>
                <span className="text-[14px] font-bold tracking-wide text-white/60">
                  Qeem
                </span>
              </div>

              <div className="mb-6 lg:mb-8">
                <span className="text-[16px] lg:text-[18px] font-black text-[#FFD700]">
                  {pkg.price}
                </span>
              </div>
            ...
            {[...PACKAGES, ...PACKAGES].map((pkg, i) => (
              <div
                ...
                className={`w-[260px] shrink-0 relative flex flex-col p-6 rounded-[24px] overflow-hidden border ${
                  pkg.popular 
                  ? 'shadow-[0_8px_32px_rgba(98,72,255,0.15)]' 
                  : ''
                }`}
                style={{ backgroundColor: pkg.bgColor, borderColor: pkg.borderColor }}
              >
                ...
                <div className="mb-6">
                  <span className="text-[16px] font-black text-[#FFD700]">
                    {pkg.price}
                  </span>
                </div>

                <p className="text-[12px] font-medium text-white/40 mb-6 mt-auto">
                  {pkg.desc}
                </p>
