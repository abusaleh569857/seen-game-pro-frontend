...
const Input = React.forwardRef(({ className, type, icon: Icon, ...props }, ref) => {
  return (
    <div className="relative">
      {Icon && (
        <div className="pointer-events-none absolute inset-y-0 flex items-center [inset-inline-start:1rem] xl:[inset-inline-start:1.25rem]">
      ...
      <input
        ...
        className={cn(
          ...
          Icon && "[padding-inline-start:2.75rem] xl:[padding-inline-start:3.5rem]",
          className
        )}
        ref={ref}
        {...props}
